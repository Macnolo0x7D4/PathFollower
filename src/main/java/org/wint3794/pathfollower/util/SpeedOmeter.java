...
import static org.wint3794.pathfollower.controllers.Robot.worldAngle;
...
public class SpeedOmeter {
    ...
    public static void update(){
        ...
        if(currTime - lastUpdateStartTime > timeBetweenUpdates){
            ...
            angularVelocity = MathFunctions.roundAngle(worldAngle -lastAngle) / elapsedTime;
            lastAngle = worldAngle;
