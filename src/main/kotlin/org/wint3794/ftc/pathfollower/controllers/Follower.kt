...
import org.wint3794.ftc.pathfollower.debug.telemetries.SimulatorSender
import org.wint3794.ftc.pathfollower.debug.Log
import org.wint3794.ftc.pathfollower.debug.RobotLogger
...
import org.wint3794.ftc.pathfollower.drivebase.RobotMovement
import org.wint3794.ftc.pathfollower.drivebase.mecanum.MecanumChassis
import org.wint3794.ftc.pathfollower.drivebase.tank.ClassicTankChassis
import org.wint3794.ftc.pathfollower.exceptions.NotCompatibleConfigurationException
...
import org.wint3794.ftc.pathfollower.util.ExecutionModes
import org.wint3794.ftc.pathfollower.util.MovementVars
import java.util.*
...
class Follower (
    ...
    init {
        ...
        robot = Robot(
            path.findFirst().x,
            path.findFirst().y,
            path.findFirst().slowDownTurnRadians
        )
