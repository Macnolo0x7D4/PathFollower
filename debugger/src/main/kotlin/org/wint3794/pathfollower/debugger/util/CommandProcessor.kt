package org.wint3794.pathfollower.debugger.util
...
class CommandProcessor {
    ...
    private fun processPoint(splitString: Array<String>) {
        ...
        debugPoints.add(Point(splitString[1].toDouble(), splitString[2].toDouble()))
    }
    ...
    private fun addPoint(splitString: Array<String>) {
        ...
        val point = Point(splitString[1].toDouble(), splitString[2].toDouble())
    ...
    private fun processLine(splitString: Array<String>) {
        ...
        debugLines.add(Line(splitString[1].toDouble(), splitString[2].toDouble(), splitString[3].toDouble(), splitString[4].toDouble()))
    }
    ...
    companion object {
        ...
        val interpolatedRobotAngle: Double
            get() {
                val currTime = System.currentTimeMillis()
                val elapsedSinceLast = currTime - lastClearTime
                val distanceToCover = MathUtils.roundAngle(robotAngle - lastRobotAngle)
